...
const testimonials = [
  {
    ...
    quote: "As a professional stylist, I'm very particular about the products I recommend. Selta Magic has transformed my clients' hair. The results are truly impressive!",
    rating: 5
  },
  {
    id: 2,
    name: "Michelle Davis",
    position: "Customer",
    quote: "I've been struggling with hair loss for years. After using Selta Magic for 3 months, my hair is noticeably thicker and healthier. I'm so grateful I found this product!",
    rating: 5
  },
  {
    id: 3,
    ...
    position: "Influencer",
    quote: "Selta Magic has become a staple in my hair care routine. The growth oil smells amazing and doesn't leave my hair feeling greasy. Highly recommend!",
    rating: 4
  },
  {
    id: 4,
    ...
    quote: "We've incorporated Selta Magic products in our premium hair treatments, and clients are consistently amazed by the results. The quality speaks for itself!",
    rating: 5
  },
  {
    id: 5,
    ...
    quote: "After trying countless hair products over the years, Selta Magic truly stands out. My followers have been asking about my hair's transformation, and I'm happy to share this secret!",
    rating: 5
  }
];
                ...
                >
                  <div className="mb-4 flex">
                    {[...Array(5)].map((_, i) => (
                      <Star 
                        key={i} 
                        className={`h-5 w-5 ${i < testimonial.rating ? 'text-selta-gold fill-selta-gold' : 'text-gray-300'}`} 
                      />
                    ))}
                  </div>
